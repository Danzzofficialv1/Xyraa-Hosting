...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY Xyraa Hosting            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "Xyra" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke XyraaHost${NC}"
    echo -e "${YELLOW}TELEGRAM : @XyraHost${NC}"
    echo -e "${YELLOW}WHATSAPP : 6285649661404${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 25K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©XyraHost${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer XyraaHost Private   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/xyrahot     ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : XyraHost ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by DanzzOffc  ${NC}"
